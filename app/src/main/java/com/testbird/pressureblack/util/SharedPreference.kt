package com.testbird.pressureblack.util
...
object SharedHelper {
    var launchedStep:Boolean by SharedUtil(appContext,"launchedStep",false)
    var launchedStart:Boolean by SharedUtil(appContext,"launchedStart",false)
    var activityInBackTime: Long by SharedUtil(appContext,"activityInBackTime", 0L)
}
